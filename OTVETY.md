...
Магнитное поле создаётся движущимися зарядами и электрическими токами. Оно действует на движущиеся заряды, проводники с током и магнитные моменты частиц. Главные характеристики поля: магнитная индукция $\vec{B}$ и напряжённость $\vec{H}$. Магнитная индукция показывает силовое действие поля, а напряжённость служит количественной мерой самого магнитного поля. Для вакуума:
...
Магнитная постоянная - константа, которая характеризует магнитные свойства вакуума:
...
Сила Лоренца — это физическая сила, с которой электромагнитное поле действует на отдельную движущуюся заряженную частицу:
...
Ускорители заряженных частиц предназначены для получения частиц высокой энергии. Электрическое поле увеличивает их кинетическую энергию, а магнитное поле изменяет направление движения и удерживает частицы на нужной траектории. Наиболее распространёнными ускорителями являются циклотрон, бетатрон и синхротрон.

Устройство циклотрона.

Состоит из двух полукруглых электродов (дуантов), источника переменного напряжения, сильного магнитного поля.

1. Частица появляется в центре

2. Электрическое поле разгоняет её. Энергия увеличивается.

3. Внутри дуанта электрического поля почти нет. Зато есть магнитное поле. Под действием силы Лоренца частица движется по полуокружности.

4. Частица выходит из одного дуанта. В этот момент напряжение меняет знак. Поле снова разгоняет частицу.

5. Скорость становится больше. Радиус увеличивается:

$$
r=\frac{mv}{qB}
$$

Поэтому частица движется по раскручивающейся спирали.

6. На краю ускорителя частица достигает большой энергии и выводится наружу.
...
$$
\oint \vec{B}\cdot d\vec{l}=\mu_0 I_{\mathrm{охв}}
$$
...
где $\varepsilon_i$ (эпсилон) — ЭДС индукции, $\Phi$ — магнитный поток, $t$ — время.
...
Токи Фуко (вихревые токи) — это замкнутые индукционные электрические токи, которые возникают внутри проводника при изменении пронизывающего его магнитного поля. 
...
Максвелл предположил: Изменяющееся электрическое поле создаёт магнитное поле так же, как и обычный ток.

Ток смещения — это физическая величина, характеризующая скорость изменения электрического пол

Формула через электрический поток:

$$
I_{\text{см}}=\varepsilon_0\frac{d\Phi_E}{dt}
$$

где $\varepsilon_0$ — электрическая постоянная, а $\Phi_E$ — поток вектора напряжённости электрического поля.
...
где $Q$ — заряд внутри замкнутой поверхности, $\rho$ — объёмная плотность заряда., D - вектор электрического смещения
...
Когда свет встречает на своём пути частицы различного размера и природы, его направление и интенсивность изменяются.
